    ...
    <div id="emissions-graphs-section" className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div id="carbon-score-card" className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm flex flex-col justify-between space-y-6">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">Tracking annual trajectory estimate (Metric Tons CO₂ / year)</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-around gap-6">
          ...
          <div className="relative w-44 h-44 shrink-0 flex items-center justify-center">
            ...
            <div className="absolute text-center">
              ...
              <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider mt-0.5">Tons / Year</p>
          ...
          <div className="space-y-4 w-full">
            <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-2xl border border-gray-100 text-xs">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-gray-400 font-semibold uppercase tracking-wider text-[9px]">Starting Baseline</div>
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-2xl border border-gray-100 text-xs">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-gray-400 font-semibold uppercase tracking-wider text-[9px]">Carbon Target Limit</div>
            ...
            <div className="flex items-center justify-between p-3 bg-emerald-65/50 rounded-2xl border border-emerald-100 leading-tight">
              <div className="flex items-center gap-2 text-xs">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-emerald-500 mt-0.5">Reducing climate change contribution</div>
                </div>
              </div>
              <div className="text-right text-xs">
                <div className="font-extrabold text-emerald-700">-{actualSavedTons.toFixed(1)} Tons</div>
                <div className="text-[10px] font-mono text-emerald-500">{savedPercent}% avoid rate</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div id="emissions-categories-card" className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm flex flex-col justify-between">
        <div>
          <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wide">Detailed Category Breakdown</h3>
          <p className="text-xs text-gray-400 mt-0.5">Baseline proportions vs relative intensity sectors</p>
        </div>
              ...
              <div key={cat.key} className="space-y-1.5 text-xs">
                <div className="flex justify-between items-center text-xs">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] font-semibold text-gray-400 font-mono">({pctOfTotal}%)</span>
                  </div>
                </div>
